...
void Rocket::update(double time)
{
    ...
    {
        if (friendly)
            if ((*b)->num != this->num && (*b)->type == unfr &&Collision::PixelPerfectTest((*b)->sprite, this->sprite))
            {
                this->boom();
            ...
            if ((*b)->num != this->num && (*b)->type == fr &&Collision::PixelPerfectTest((*b)->sprite, this->sprite))
            {
                this->boom();
